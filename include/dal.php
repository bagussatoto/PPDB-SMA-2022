...
class tDAL
{
	var $tblppdb2022_at_localhost__calonppdb;
	var $tblppdb2022_at_localhost__pekerjaan;
	var $tblppdb2022_at_localhost__pendidikan;
	var $tblppdb2022_at_localhost__penghasilan;
	var $tblppdb2022_at_localhost__ppdb2022_uggroups;
	var $tblppdb2022_at_localhost__ppdb2022_ugmembers;
	var $tblppdb2022_at_localhost__ppdb2022_ugrights;
	var $tblppdb2022_at_localhost__user;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "calonppdb", "varname" => "ppdb2022_at_localhost__calonppdb", "altvarname" => "calonppdb", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "pekerjaan", "varname" => "ppdb2022_at_localhost__pekerjaan", "altvarname" => "pekerjaan", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "pendidikan", "varname" => "ppdb2022_at_localhost__pendidikan", "altvarname" => "pendidikan", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "penghasilan", "varname" => "ppdb2022_at_localhost__penghasilan", "altvarname" => "penghasilan", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "ppdb2022_uggroups", "varname" => "ppdb2022_at_localhost__ppdb2022_uggroups", "altvarname" => "ppdb2022_uggroups", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "ppdb2022_ugmembers", "varname" => "ppdb2022_at_localhost__ppdb2022_ugmembers", "altvarname" => "ppdb2022_ugmembers", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "ppdb2022_ugrights", "varname" => "ppdb2022_at_localhost__ppdb2022_ugrights", "altvarname" => "ppdb2022_ugrights", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
		$this->lstTables[] = array("name" => "user", "varname" => "ppdb2022_at_localhost__user", "altvarname" => "user", "connId" => "ppdb2022_at_localhost", "schema" => "", "connName" => "ppdb2022 at localhost");
	}
