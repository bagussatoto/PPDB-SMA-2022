...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="calonppdb" && $field=="nomap")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="namalengkap")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="tempatlahir")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="alamatjalan")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="dusun")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="deskel")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="kecamatan")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="namaayah")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="asaltk")
	{
		$value = strtoupper($value);;
		return $value;
	}
				if($table=="calonppdb" && $field=="namaibu")
	{
		$value = strtoupper($value);;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="calonppdb" && $field=="tanggaldaftar")
	{
		return NOW();
	}
	return "";
